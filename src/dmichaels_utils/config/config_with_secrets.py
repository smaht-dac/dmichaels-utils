...
from dmichaels_utils.type_utils import is_primitive_type, primitive_type
...
class ConfigWithSecrets(ConfigBasic):
    ...
    def _secrets_plaintext_value(self, value: str) -> Tuple[primitive_type, Any]:
        from dmichaels_utils.config.config_with_aws_macros import ConfigWithAwsMacros  # here to avoid circular imports
        value_typed = None
